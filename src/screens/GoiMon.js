    ...
    return (
        ...
        <View style ={{marginLeft:15,marginRight:15}}>
            <View style={{backgroundColor:'white',height:280}}>
                ...
                source={{
                uri: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQexBgEWn7qHKF6zum43jSVPmD9tHjGfVXRVA&usqp=CAU',
                }}
            />
            </View>
            ...
            <Text style ={{textAlign:'center'}}>Bằng việc đăng nhập, bạn đã đồng ý với <Text style ={{textDecorationLine:'underline',color:'#008000'}}>Điều khoản sử dụng</Text> của Soya Garden</Text>
            </View>
